...
// (2026-05-12) — contracts/src/StructHash.sol
// Dependency of RiscZeroGroth16Verifier.sol; cartesi/dave @ a4249a58 pin
// context is documented in StepVerifier.sol. NOTE: the openzeppelin SafeCast
// import below is not vendored; run `forge install OpenZeppelin/openzeppelin-contracts`
// (or equivalent) before attempting to compile RiscZeroGroth16Verifier.sol.
// -----------------------------------------------------------------------------
