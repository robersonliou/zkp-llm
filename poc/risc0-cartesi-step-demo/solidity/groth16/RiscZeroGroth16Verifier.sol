...
// (2026-05-12) — contracts/src/groth16/RiscZeroGroth16Verifier.sol
// Concrete IRiscZeroVerifier implementation. cartesi/dave @ a4249a58 pin
// context is documented in StepVerifier.sol. NOTE: import paths for
// "../IRiscZeroVerifier.sol", "../StructHash.sol", "../Util.sol" and
// "../IRiscZeroSelectable.sol" assume the parent folder is on the include
// path; the openzeppelin SafeCast dep is NOT vendored (see StructHash.sol).
// -----------------------------------------------------------------------------
