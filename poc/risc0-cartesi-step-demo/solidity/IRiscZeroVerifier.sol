...
// (2026-05-12) — contracts/src/IRiscZeroVerifier.sol
// Used by StepVerifier.sol below; pin context is documented there.
// cartesi/dave @ a4249a58 (2026-03-10) does NOT ship a RISC0 verifier (dave
// implements the PRT interactive fraud-proof protocol via UArchStep, see
// prt/contracts/src/state-transition/RiscVStateTransition.sol). The "ZK
// fallback" path discussed in cartesi/machine-emulator PR #343 reuses RISC
// Zero's canonical IRiscZeroVerifier interface — that is what is copied here.
// -----------------------------------------------------------------------------
